...
if __name__ == "__main__":
    ...
    try:
        opts, args = getopt.getopt(sys.argv[1:], "hVvc:e:", [
                                   "help", "version", "verbose", "conf=", "config=", "execute="])
    ...
    try:
        ...
        interp.cmdloop(FloatingPointError)

        interp.cmdloop()
    except SystemExit:
        interp.p.disconnect()
    except:
        logging.error(("Caught an exception, exiting:") +
